...
from ..blocks import ConvBnRelu, resnet18

from .blocks import FeatureFusion, AttentionRefinement
...
class BiSegNet(nn.Module):
    def __init__(
        ...
        self.spatial_path = SpatialPath(in_channels, 128, norm_layer)
        ...
        if is_training:
            heads = [
                BiSeNetHead(conv_channel, n_classes, 2, True, norm_layer),
                BiSeNetHead(conv_channel, n_classes, 1, True, norm_layer),
                BiSeNetHead(conv_channel * 2, n_classes, 1, False, norm_layer),
            ]
        else:
            heads = [
                None,
