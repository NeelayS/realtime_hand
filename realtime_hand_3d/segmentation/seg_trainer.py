...
from .dataset import Ego2HandsDataset, FreiHandDataset
...
class SegTrainer:
    ...
    def _make_dataloader(self):
        ...
        elif self.cfg.dataset == "FreiHand":
            dataset = FreiHandDataset(img_dir=self.img_dir, labels_dir=self.labels_dir)
