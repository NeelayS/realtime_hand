...
from .pspnet import PSPHead_res50
...
class CustomICNet(nn.Module):
    def __init__(self, in_channels=1, n_classes=3):
        super(CustomICNet, self).__init__()
        ...
        self.head = _ICHead(n_classes=n_classes)
    ...
    def forward(self, x):
        ...
        x_sub4 = F.interpolate(
            x_sub2_out, scale_factor=0.5, mode="bilinear", align_corners=True
        )
